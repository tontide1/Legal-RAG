---
description: High-level design patterns for LLM applications. Use for broad architecture
  choices, but prefer project-specific skills first for this Legal Graph RAG repository.
  Use this skill when Comparing RAG vs agentic flows, Choosing where retrieval, memory,
  and tools should live, Designing observability or evaluation at the application
  level, Refactoring a broad LLM workflow, not one narrow subsystem.
