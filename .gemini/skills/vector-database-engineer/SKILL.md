---
description: Design vector storage and retrieval indexing for RAG systems. Use for
  Neo4j-stored embeddings, candidate retrieval strategy, metadata filtering, and tradeoffs
  around introducing a dedicated vector database. Use this skill when Changing how
  embeddings are stored or queried, Tuning candidate retrieval latency or recall,
  Adding metadata filters or hybrid search strategy, Evaluating whether Neo4j is enough
