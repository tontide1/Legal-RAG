...
description: Master Python 3.12+ with modern features, async programming, performance
  ...
  including uv, ruff, pydantic, and FastAPI. Use this skill when Writing or reviewing
  Python 3.12+ codebases, Implementing async workflows or performance optimizations,
