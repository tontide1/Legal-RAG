...
description: Use when encountering any bug, test failure, or unexpected behavior,
  before proposing fixes. Emphasizes root-cause investigation and evidence-first debugging.
  Use this skill when Tests fail, Retrieval quality regresses, Neo4j writes produce
  unexpected graph state, Gemini output changes unexpectedly, The pipeline works but
