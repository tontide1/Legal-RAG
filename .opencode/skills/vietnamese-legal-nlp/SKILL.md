...
description: Project-specific guidance for Vietnamese legal text processing. Use for legal citation parsing, chunking by article structure, NER limitations, normalization, and retrieval behavior on Vietnamese law documents.
risk: medium
source: personal
